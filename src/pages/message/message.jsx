...
function Message() {
  ...
  return (
    <div>
        <div className='w-full md:block flex relative overflow-x-hidden'>
                <div className={`md:fixed md:w-[350px] md:min-w-0 min-w-full h-[calc(100%_-_72px)] flex flex-col gap-2 p-4 no-scrollbar overflow-y-scroll transition-all duration-300 ease-out ${msgOpen ? "-translate-x-full md:translate-x-0" : "translate-x-0"}`}>
                ...
                <div className={`w-full md:flex md:justify-end md:min-w-0 min-w-full `}>
                    <div className={`md:w-[calc(100%_-_350px)] w-full px-4 relative transition-all duration-300 ease-out  ${msgOpen ? "md:translate-x-0  -translate-x-full" : "translate-x-0"}` }>
                        <div className="bg-gray-100 flex justify-between items-center border-b py-4 border-b-gray-300">
                        ...
                        <div className='chat my-3 flex flex-col text-sm'>
                            ...
                            <div className='flex gap-2 my-4 text-sm'>
                                ...
                                <div>
                                    <div className='flex flex-col gap-2'>
                                        <div className='py-2 px-4 bg-indigo-100 rounded-tr-2xl rounded-tl-2xl rounded-br-2xl text-gray-700 max-w-md'>
                                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Animi numquam incidunt, sequi, omnis porro </p>
                                        </div>
                        ...
                        <div className='fixed w-full bottom-0 py-2 bg-gray-100'>
                            <div className='relative py-2 px-2 bg-white rounded-full flex'>
