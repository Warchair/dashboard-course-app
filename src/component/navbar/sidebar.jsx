...
function Sidebar(props) {
	...
	return (
			<div>
				<div className={`w-[250px] z-[999] px-4 py-4 overflow-y-scroll h-screen bg-white dark:bg-slate-800 no-scrollbar lg:relative absolute transition-all duration-300 ease-out ${props.active ? "translate-x-0" : "lg:translate-x-0 -translate-x-[250px]"}`}>
					<div className="">
						<div className='flex gap-3 items-center'>
							<div className="text-gray-700 dark:text-gray-300 cursor-pointer lg:hidden block" onClick={props.sidebarOpen}>
								<ArrowNarrowLeftIcon className="h-6 w-6" />
							</div>
							<div className="flex gap-2 items-center">
								<img src={logo} alt='' />
								<h4 className='font-bold text-xl text-black dark:text-white'>Omni.</h4>
							</div>
						</div>
					</div>
					<div className="lg:pt-0 pt-8">
						...
						<div className='flex- flex-col place-content-center w-full mt-20'>
							<div className=' w-40 h-40 rounded-lg bg-teal-50 dark:bg-slate-700 px-4 text-center mx-auto flex flex-col place-content-end py-3 relative'>
								...
								<h3 className='font-medium text-lg text-gray-800 dark:text-white'>Invite Friend</h3>
